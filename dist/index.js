...
class KiroMemServer {
    ...
    setupHandlers() {
        ...
        this.server.setRequestHandler(CallToolRequestSchema, async (request) => {
            ...
            switch (name) {
                case 'store_context':
                    await this.memory.store(args.key, args.content, args.tags || []);
                ...
                case 'list_contexts':
                    const contexts = await this.memory.list(args.limit);
                    return {
                        content: [{
                                type: 'text',
                ...
                case 'delete_context':
                    const deleted = await this.memory.delete(args.key);
                    return {
                        content: [{
                                type: 'text',
